...
const HELP_DATA = {
  ...
  "抽卡娱乐": {
    ...
    items: [
      ...
      { name: "设置UP池关闭", desc: "到点自动关闭UP池（管理）", eg: "设置UP池关闭 2026-09-15 12:00", icon: "抽卡" },
      { name: "创建UP池", desc: "创建自定义UP池（贵人20%/普通59%）（管理）", eg: "创建UP池 贵人池 贵人 四宫辉夜", icon: "抽卡" },
      { name: "解散UP池", desc: "解散自定义UP池（管理）", eg: "解散UP池 贵人池", icon: "抽卡" },
      { name: "切换竹林/樱花", desc: "切换个人卡池，仅对自己生效", eg: "切换樱花", icon: "抽卡" },
      { name: "切换卡池", desc: "切换到指定自定义UP池（个人）", eg: "切换卡池 贵人池", icon: "抽卡" },
      { name: "我的卡池", desc: "查看群默认池与我的卡池", eg: "我的卡池", icon: "抽卡" },
      { name: "重置卡池", desc: "重置为跟随本群默认池", eg: "重置卡池", icon: "抽卡" },
      { name: "查看性别池", desc: "查看竹林/樱花名单（主人）", eg: "查看性别池", icon: "抽卡" },
