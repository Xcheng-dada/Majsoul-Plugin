...
const HELP_DATA = {
  ...
  "抽卡娱乐": {
    ...
    items: [
      ...
      { name: "创建UP池", desc: "挂靠樱花/竹林创建UP池（主人）", eg: "创建UP池 赤影骁歌 樱花 贵人 赤麟", icon: "抽卡" },
      { name: "解散UP池", desc: "解散自定义UP池，退回樱花之路（主人）", eg: "解散UP池 赤影骁歌", icon: "抽卡" },
      { name: "开启联动", desc: "开启联动池（樱花+竹林都开，主人）", eg: "开启联动 斗牌传说", icon: "抽卡" },
      { name: "关闭联动", desc: "关闭联动，退回樱花之路（主人）", eg: "关闭联动", icon: "抽卡" },
      { name: "查看联动池", desc: "查看联动池列表与状态（主人）", eg: "查看联动池", icon: "抽卡" },
      { name: "设置UP池关闭", desc: "到点自动关闭UP池（主人）", eg: "设置UP池关闭 2026-09-15 12:00", icon: "抽卡" },
      { name: "切换竹林/樱花", desc: "切换个人卡池，仅对自己生效", eg: "切换樱花", icon: "抽卡" },
      { name: "切换卡池", desc: "切自定义UP池/联动池樱花竹林版（个人）", eg: "切换卡池 斗牌传说 竹林", icon: "抽卡" },
      { name: "查看雀魂卡池", desc: "查看当前可用池与个人卡池", eg: "查看雀魂卡池", icon: "抽卡" },
      { name: "重置卡池", desc: "重置为跟随本群默认池", eg: "重置卡池", icon: "抽卡" },
      { name: "查看性别池", desc: "查看竹林/樱花雀士名单（主人，名单直接改文件）", eg: "查看性别池", icon: "抽卡" },
