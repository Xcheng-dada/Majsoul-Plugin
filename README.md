...
| `#雀魂订阅 [玩家昵称]` | 订阅该玩家的对局播报（四麻模式）。 | `#雀魂订阅 宫永咲` |
| `#三麻订阅 [玩家昵称]` | 订阅该玩家的对局播报（三麻模式）。 | `#三麻订阅 宫永咲` |
| `#雀魂订阅状态` | 查看本群的四麻订阅列表。 | `#雀魂订阅状态` |
| `#三麻订阅状态` | 查看本群的三麻订阅列表。 | `#三麻订阅状态` |
| `#关闭雀魂订阅 [昵称]` | 临时关闭指定玩家的播报。 | `#关闭雀魂订阅 宫永咲` |
| `#开启雀魂订阅 [昵称]` | 重新开启指定玩家的播报。 | `#开启雀魂订阅 宫永咲` |
| `#删除雀魂订阅 [昵称]` | 删除指定玩家的订阅。 | `#删除雀魂订阅 宫永咲` |
| `#关闭三麻订阅 [昵称]` | 临时关闭指定玩家的三麻播报。 | `#关闭三麻订阅 宫永咲` |
| `#开启三麻订阅 [昵称]` | 重新开启指定玩家的三麻播报。 | `#开启三麻订阅 宫永咲` |
| `#删除三麻订阅 [昵称]` | 删除指定玩家的三麻订阅。 | `#删除三麻订阅 宫永咲` |
| `#雀魂对局 [玩家昵称]` | 查询玩家最近5场四麻对局记录。 | `#雀魂对局 宫永咲` |
| `#雀魂牌谱 [玩家昵称]` | 查询玩家最近5场四麻对局记录（同雀魂对局）。 | `#雀魂牌谱 宫永咲` |
| `#四麻对局 [玩家昵称]` | 查询玩家最近5场四麻对局记录。 | `#四麻对局 宫永咲` |
| `#三麻对局 [玩家昵称]` | 查询玩家最近5场三麻对局记录。 | `#三麻对局 宫永咲` |
